          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <div className="d-flex flex-row justify-content-end">
                <span className="mr-2">
                <i className="fas fa-square text-blue" /><a href="/ContentOneBar">Ladkrabang</a> {/* the word primary can be change to any color */}
                  <i className="fas fa-square text-red" /> <a href="/MockupGreenBar">Bangkapi</a>
                  <i className="fas fa-square text-green" /> <a href="/MockupRedBar">Ladprao</a>
                </span>
              </div>
            </div>
          </div>
